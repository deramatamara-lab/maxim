 ...
 * Supports English and Bulgarian languages for Project Aura
 */
...
const resources = {
  en: {
    translation: {
      ...
      location: {
        ...
        map_description: "Interactive maps and real-time location tracking will be available in the next update.",
        real_time_gps: "Real-time GPS tracking",
  ...
  bg: {
    translation: {
      ...
      location: {
        title: "Локация",
        subtitle: "Карта и Навигация",
        map_coming_soon: "Карта идва скоро",
        map_description: "Интерактивни карти и проследяване на местоположение в реално време ще бъдат налични в следващата актуализация.",
        real_time_gps: "Проследяване на GPS в реално време",
        route_optimization: "Оптимизация на маршрута",
        traffic_updates: "Актуална информация за трафика",
